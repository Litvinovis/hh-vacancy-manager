...
class PipelineSchedulerTest {
    ...
    void setUp() {
        ...
        scheduler = new PipelineScheduler(pipeline, profiles, config, analyzer, searchRepo,
            freeModels, flags, schema, subscriptions, publisher, engagement, vacancyRepo, null /* vkPublishQueue */, null, null,
    ...
    void rollingMetrics_repositoryThrows_doesNotBreakOtherTasks() {
        ...
        scheduler = new PipelineScheduler(pipeline, profiles, config, analyzer, searchRepo,
            freeModels, flags, schema, subscriptions, publisher, engagement, throwing, null /* vkPublishQueue */, null, null, telegramMetrics, null, currencyRates, null);
    ...
    void aTaskThrowing_neverEscapesToTheScheduler() {
        ...
        scheduler = new PipelineScheduler(pipeline, profiles, config, analyzer, searchRepo,
            freeModels, flags, schema, subscriptions, exploding, engagement, vacancyRepo, null /* vkPublishQueue */, null, null,
